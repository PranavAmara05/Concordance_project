...
def setup_protobuf():
    try:
        ...
        install_package("protobuf", "3.20.*")
    else:
        # Set environment variable to enforce Python implementation
        os.environ["PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION"] = "python"
        print("Set PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python for compatibility.")
...
def main():
    ...
    # Evaluate the model
    predictions, references = evaluate_model(model, tokenizer, test_data)
